...
function AddEditCourier(props)
{
	...
	const tokenId = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJMb2dpbklERW5jcnlwdCI6IkdJb2RoSmpZblVKTkN4MmMwVWFZeGc9PSIsIm5iZiI6MTcwOTk3NDQ3MSwiZXhwIjoxNzA5OTc1MDcxLCJpYXQiOjE3MDk5NzQ0NzF9.e3OD8jAwY9YJsrFgla03iGtaY7ZF_iMFFLRthGhKp2Y';
	...
	const InsertOrUpdateCourier = (values) => {
		...
		.catch(error => console.log(" => ERROR from InsertOrUpdateCourier : " + error.message))
	}
	...
	const getCourierbyIdforEdit = () => {
        ...
        .catch(error => console.log(" => ERROR from getCourierbyIdforEdit : " + error.message))
    };
